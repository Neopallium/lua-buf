...
"\n"
"const char * l_buffer_data(LBuffer * this);\n"
"\n"
"size_t l_buffer_length(LBuffer * this);\n"
"\n"
"void l_buffer_reset(LBuffer * this);\n"
"\n"
"size_t l_buffer_length(LBuffer * this);\n"
"\n"
"bool l_buffer_set_length(LBuffer * this, size_t len);\n"
"\n"
"void * l_buffer_data(LBuffer * this);\n"
"\n"
"size_t l_buffer_size(LBuffer * this);\n"
"\n"
"bool l_buffer_resize(LBuffer * this, size_t len);\n"
"\n"
"int l_buffer_read_uint8_t(LBuffer * this, uint8_t *num);\n"
"\n"
"int l_buffer_read_uint8_t(LBuffer * this, int8_t *num);\n"
"\n"
"int l_buffer_read_uint16_t(LBuffer * this, uint16_t *num);\n"
"\n"
"int l_buffer_read_uint16_t(LBuffer * this, int16_t *num);\n"
"\n"
"int l_buffer_read_uint32_t(LBuffer * this, uint32_t *num);\n"
"\n"
"int l_buffer_read_uint32_t(LBuffer * this, int32_t *num);\n"
"\n"
"int l_buffer_read_uint64_t(LBuffer * this, uint64_t *num);\n"
"\n"
"int l_buffer_read_uint64_t(LBuffer * this, int64_t *num);\n"
"\n"
"int l_buffer_read_float(LBuffer * this, float *num);\n"
"\n"
"int l_buffer_read_double(LBuffer * this, double *num);\n"
"\n"
"int l_buffer_read_b128_uvar32(LBuffer * this, uint32_t *num);\n"
"\n"
"int l_buffer_read_b128_var32(LBuffer * this, int32_t *num, bool zigzag);\n"
"\n"
"int l_buffer_read_b128_uvar64(LBuffer * this, uint64_t *num);\n"
"\n"
...
"\n"
"int l_buffer_append_uint8_t(LBuffer * this, int8_t num);\n"
"\n"
"int l_buffer_append_uint16_t(LBuffer * this, uint16_t num);\n"
"\n"
"int l_buffer_append_uint16_t(LBuffer * this, int16_t num);\n"
"\n"
"int l_buffer_append_uint32_t(LBuffer * this, uint32_t num);\n"
"\n"
"int l_buffer_append_uint32_t(LBuffer * this, int32_t num);\n"
"\n"
"int l_buffer_append_uint64_t(LBuffer * this, uint64_t num);\n"
"\n"
"int l_buffer_append_uint64_t(LBuffer * this, int64_t num);\n"
"\n"
"int l_buffer_append_float(LBuffer * this, float num);\n"
"\n"
"int l_buffer_append_double(LBuffer * this, double num);\n"
"\n"
"int l_buffer_append_b128_uvar32(LBuffer * this, uint32_t num);\n"
"\n"
"int l_buffer_append_b128_var32(LBuffer * this, int32_t num, bool zigzag);\n"
"\n"
"int l_buffer_append_b128_uvar64(LBuffer * this, uint64_t num);\n"
"\n"
"int l_buffer_append_b128_var64(LBuffer * this, int64_t num, bool zigzag);\n"
"\n"
"\n"
"]]\n"
"\n"
...
"  rc_l_buffer_data = C.l_buffer_data(this)\n"
